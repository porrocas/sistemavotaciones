                        ...
                        <div class="col-md-8 d-flex flex-wrap justify-content-center align-items-center">
                            <form class="w-100">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" required>Ninguna.</textarea>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6 mx-auto">
                                        <button type="submit" class="btn btn-primary btn-block btn-lg">Votar</button>
                                    </div>
                                </div>
                            </form>
                        </div>
